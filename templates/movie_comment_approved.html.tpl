<div class="card" style="width: 900px; margin: 30px;">
    <div class="card-body">
        ...
        <div style="margin-bottom: 30px;">
            <h6 class="card-subtitle mb-2 text-muted" style="float: right; margin-left: 10px;">Points: {$approved_comment.puntuacion}</h6>
        </div>
        <div class="card-body"
             style="background: #f3f3f3; border-radius: 3px; border-color: #e1e1e1; margin-top: 8px; margin-bottom: 10px;">
            <p class="card-text" style="padding-top: 5px;">{$approved_comment.mensaje}</p>
        </div>
    </div>
</div>